export const tr = {
  ...
  'contract.intro': 'Avukatlık ücret veya sürekli danışmanlık sözleşmesini şablondan hazırlayın. Müvekkili listeden seçince bilgiler önden dolar. Belge cihazınızda oluşturulur; Paylaş ile gönderebilirsiniz.',
  ...
  'contract.matter': 'İş / Konu',
  'contract.lawArea': 'Hukuk Alanı',
  'contract.subject': 'Konu / Uyuşmazlık',
  'contract.court': 'Yetkili Merci',
  'contract.role': 'Müvekkilin Sıfatı',
  'contract.signPlace': 'İmza Yeri (yetki)',
  'contract.fee': 'Ücret',
