export const tr = {
  ...
  'ictihat.analyzeTitle': 'Olayını anlat, içtihatı bulsun',
  'ictihat.analyzeDesc': 'İhtilafı kendi cümlelerinle yaz; yapay zekâ hukuki değerlendirme yapıp olaya uygun gerçek kararları getirsin.',
