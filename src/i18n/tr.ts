export const tr = {
  ...
  'auth.kvkkNote': 'Bu rıza yalnızca yapay zekâ özellikleri içindir; dilediğiniz zaman Ayarlar’dan geri alabilirsiniz. Geri aldığınızda uygulamanın diğer tüm özellikleri çalışmaya devam eder.',
