export const tr = {
  ...
  'forgot.emailStep': 'Hesabınızın e-posta adresini girin; size bir doğrulama kodu gönderelim.',
  'forgot.sendCode': 'Kod Gönder',
  'forgot.codeStep': 'E-postanıza gelen kodu ve yeni şifrenizi girin.',
  ...
  'plan.limitBaslik': 'Ücretsiz plan sınırı',
  'plan.planlariGor': 'Planları gör',
  'plan.doldu.dava': 'Ücretsiz planda {n} dava açabilirsiniz ve bu hakkınız doldu. Mevcut davalarınız duruyor; yenisini eklemek için Vekil Pro’ya geçin.',
  'plan.doldu.muvekkil': 'Ücretsiz planda {n} müvekkil kaydedebilirsiniz ve bu hakkınız doldu. Mevcut kayıtlarınız duruyor; yenisini eklemek için Vekil Pro’ya geçin.',
  'plan.doldu.belge': 'Ücretsiz planda {n} belge yükleyebilirsiniz ve bu hakkınız doldu. Yüklediğiniz belgeler duruyor; yenisini eklemek için Vekil Pro’ya geçin.',
  'plan.doldu.finans': 'Finans modülü Vekil Pro planına dahildir.',
  'plan.kapali.dava': 'Bu özellik Vekil Pro planına dahildir.',
  'plan.kapali.muvekkil': 'Bu özellik Vekil Pro planına dahildir.',
  'plan.kapali.belge': 'Bu özellik Vekil Pro planına dahildir.',
  'plan.kapali.finans': 'Gelir-gider takibi, tahsilat ve finansal raporlar Vekil Pro planına dahildir. İçtihat araması ve ajandanız ücretsiz kalmaya devam eder.',
  'auth.captchaWait': 'Güvenlik doğrulaması sürüyor, bir saniye…',
  'auth.verifyTitle': 'E-postanızı doğrulayın',
  ...
  'auth.kvkkConsent': 'Yapay zekâ özelliklerini kullanabilmem için, bu özelliklere kendi elimle girdiğim metinlerin yurt dışındaki (ABD) yapay zekâ sağlayıcılarına aktarılmasına açık rıza veriyorum.',
  'auth.kvkkLink': 'KVKK Aydınlatma Metni’ni okuyun',
  'auth.kvkkOpen': 'KVKK Aydınlatma Metni’ni aç, oku ve imzala',
  'auth.kvkkReopen': 'Metni yeniden aç',
  ...
  'changePw.currentRequired': 'Mevcut şifrenizi yazın.',
  ...
  'premium.proBadge': 'SINIRSIZ',
  'premium.subscribeCta': 'Aboneliğe Geç',
  'premium.f.freeAll': 'Ücretsiz plandaki her şey (sınırsız içtihat, ajanda, şablonlar, hesaplayıcılar)',
  'premium.f.allCases': 'Sınırsız dava, müvekkil ve belge — sayı sınırı kalkar',
  'premium.f.financeFull': 'Finans modülü: gelir-gider, tahsilat ve finansal özet (ücretsiz planda kapalıdır)',
  'premium.f.aiSeparate': 'Yapay zekâ özellikleri ayrı pakettedir (aşağıda)',
  'premium.aiName': 'Vekil Pro + Yapay Zekâ',
  'premium.aiTag': 'Araştırma ve taslak yazımında yapay zekâ desteği',
  ...
  'premium.leadFreeFirst': 'İçtihat araması ve ajandanız ücretsiz. Ödeme yalnızca büro yönetimini büyütmek ya da yapay zekâyı kullanmak isteyenler için.',
  'premium.ictihatFreeNote': 'Yargıtay, Danıştay, istinaf ve yerel mahkeme kararlarında sınırsız arama — ücretsiz planda da açık, hiçbir zaman ücretli olmayacak.',
  'premium.freeName': 'Ücretsiz',
  'premium.freeTag': 'Kayıt olan herkes için',
  'premium.freePrice': '0 ₺',
  ...
  'premium.f.aiQuotaSoruOnly': 'Ayda {soru} yapay zekâ sorusu dahil (ilk {asil} soru ana modelle, sonrası daha hafif modelle yanıtlanır)',
  'premium.f.aiAssistant': 'Vekil AI asistanı — hukuki soru, süre ve usul konularında yardımcı',
  'premium.f.aiMutalaa': 'Derin Araştırma: olayı hukuki sorunlara bölüp her biri için ayrı ayrı mevzuat ve içtihat tarar',
  ...
  'premium.f.mutalaa': 'Derin Araştırma: çok adımlı mevzuat ve içtihat taraması',
  ...
  // Zaman / çalışma kaydı — 0131_zaman_kaydi.sql
  'time.title': 'Çalışma Kayıtları',
  'time.newTitle': 'Çalışma Kaydı',
  'time.noCase': 'Dosyasız çalışma',
  'time.duration': 'Süre',
  'time.durationPlaceholder': '90 · 1,5 · 1:30 · 45dk',
  // Ayrıştırma kuralı kullanıcıya AÇIKÇA yazılıyor; tahmin ettirmiyoruz.
  'time.durationHint': 'Düz sayı dakika, ondalık saat sayılır: "90" = 90 dk, "1,5" = 1 sa 30 dk',
  'time.durationRead': 'Okundu: {{sure}}',
  'time.durationUnreadable': 'Bu süre okunamadı — örnek: 90, 1,5, 1:30, 45dk',
  'time.durationInvalid': 'Geçerli bir süre girin.',
  'time.description': 'Ne yapıldı',
  'time.descriptionPlaceholder': 'Dilekçe hazırlandı, müvekkil görüşmesi...',
  'time.descriptionRequired': 'Ne yapıldığını yazın.',
  'time.workedAt': 'Çalışma tarihi',
  'time.billable': 'Ücretlendirilecek',
  'time.billableHint': 'Kapatırsanız süre yine sayılır, tutara girmez.',
  'time.hourlyRate': 'Saatlik ücret (₺)',
  'time.hourlyRatePlaceholder': '3000',
  'time.previewAmount': 'Bu kaydın tutarı',
  // Boş ücret yasak değil ama sonucu söyleniyor: sessiz sıfır, eksik faturadır.
  'time.noRateWarn': 'Saatlik ücret girilmedi — bu kayıt toplam tutarda görünmez.',
  'time.save': 'Kaydet',
  'time.saveFailed': 'Çalışma kaydı kaydedilemedi.',
  'time.setupRequired': 'Çalışma kaydı tablosu henüz kurulmamış.',
  'time.empty': 'Henüz çalışma kaydı yok',
  'time.emptyDesc': 'Bu dosyada geçirdiğiniz süreyi kaydedin; hangi işin ne kadar sürdüğünü sonra ancak buradan görebilirsiniz.',
  'time.add': 'Süre Ekle',
  'time.total': 'Toplam süre',
  'time.billableTotal': 'Ücretli süre',
  'time.amountTotal': 'Toplam tutar',
  'time.missingRate': '{{adet}} kayıtta saatlik ücret yok — tutara dahil değil.',
  'time.deleteTitle': 'Çalışma Kaydını Sil',
  'time.deleteConfirm': 'Bu çalışma kaydı silinsin mi?',
  'time.unbilled': 'Ücretsiz',
  'time.export': 'Dışa aktar',
  // Süre CSV'de iki kez yazılıyor: okunur biçim insan için, ondalık saat
  // Excel'de çarpılabilsin diye. Elle çevrim hata üretir.
  'time.hoursColumn': 'Saat (ondalık)',
  // Çalışan sayaç
  'time.timerStart': 'Sayacı başlat',
  'time.timerStop': 'Durdur ve kaydet',
  'time.timerRunning': 'Sayaç çalışıyor',
  'time.timerCancel': 'Sayacı iptal et',
  'time.timerCancelConfirm': 'Çalışan sayaç iptal edilsin mi? Geçen süre kaydedilmez.',
  'time.timerBusy': 'Başka bir dosyada sayaç çalışıyor: {{dosya}}',
  ...
  'reports.timeByCase': 'Zaman — Hangi Dosya',
  'toplu.short': 'Toplu Aktarım',
  'toplu.title': 'Toplu Dosya Aktarımı',
  'toplu.intro': 'Başka bir programdan ya da UYAP\'tan aldığınız dosya listesini buraya yükleyin. Hangi sütunun ne olduğunu siz seçersiniz — biçimi önceden bilmemize gerek yok.',
  // Excel (.xlsx) sıkıştırılmış bir XML paketi; çözmek için yeni bir kütüphane
  // gerekiyor. Gerçek bir UYAP çıktısı görülmeden depoya bağımlılık eklenmedi.
  'toplu.csvOnly': 'Şimdilik CSV dosyası kabul ediliyor. Excel\'de: Dosya → Farklı Kaydet → CSV.',
  'toplu.pick': 'Dosya Seç',
  'toplu.change': 'Değiştir',
  'toplu.rowCount': '{{adet}} satır okundu',
  'toplu.tooShort': 'Dosyada başlık satırı ve en az bir kayıt olmalı.',
  'toplu.readFailed': 'Dosya okunamadı. CSV olduğundan emin olun.',
  'toplu.mapTitle': 'Sütunları eşleyin',
  'toplu.mapHint': 'Başlıklara bakıp tahmin ettik; yanlışsa değiştirin. Aynı sütun iki alana atanamaz.',
  'toplu.none': 'Yok',
  'toplu.unnamedColumn': '{{no}}. sütun',
  'toplu.previewTitle': 'Yazmadan önce',
  'toplu.ready': '{{adet}} dosya aktarılacak',
  'toplu.skipped': '{{adet}} satır atlanacak',
  'toplu.skippedRow': '{{no}}. satır: {{sebep}}',
  'toplu.andMore':'ve {{adet}} kayıt daha',
  'toplu.start': '{{adet}} dosyayı aktar',
  'toplu.writing': 'Aktarılıyor… {{n}}/{{toplam}}',
  'toplu.doneTitle': 'Aktarım tamamlandı',
  ...
  'makbuz.client': 'Müşteri (müvekkil) adı',
  'makbuz.clientPlaceholder': 'Belgede görünecek ad / unvan',
  'makbuz.no': 'Makbuz no',
  'makbuz.noPlaceholder': 'Örn. A-2026-001',
  'makbuz.notFound': 'Kayıt bulunamadı',
  'makbuz.notFoundDesc': 'Bu finans kaydı silinmiş olabilir.',
  'makbuz.loading': 'Kayıt yükleniyor…',
  // Bu uyarı hem ekranda hem belgenin içinde duruyor. İkisi de gerekli:
  // belge paylaşıldığında ekran uyarısı onunla gitmez.
  'makbuz.notOfficial': 'Bu bir DÖKÜMDÜR, resmî serbest meslek makbuzu değildir ve onun yerine geçmez. Resmî makbuz e-SMM düzeni üzerinden ya da tasdikli koçandan düzenlenir.',
  'profile.hourlyRate': 'Varsayılan saatlik ücret (₺)',
  'profile.hourlyRatePlaceholder': 'Boş bırakabilirsiniz',
  'profile.hourlyRateHint': 'Yeni çalışma kaydı formunu ön-doldurur. Kayda kopyalanır: sonradan değiştirmeniz eski kayıtların tutarını bozmaz.',
  ...
  'financeForm.applyWithholding': 'Stopaj kesildi',
  'financeForm.withholdingRate': 'Stopaj oranı (%)',
  'financeForm.vatAmount': 'KDV',
  'financeForm.withholdingAmount': 'Stopaj',
  'financeForm.netTotal': 'Eline geçecek',
  'financeForm.receiptNo': 'Serbest meslek makbuzu no (isteğe bağlı)',
  'financeForm.receiptNoPlaceholder': 'Örn. 2026/014',
  ...
  'mut.groundsTitle': 'Taramada kullanılan kurallar ({n})',
  ...
  'soon.mutalaa': 'Derin Araştırma çok yakında',
  ...
  // Ücretsiz plan bildirimi (deneme süresi yok — ücretsiz katman kalıcı)
  'plan.freePill': 'Ücretsiz plandasınız — Vekil Pro’ya göz atın',
  'ai.tierBasic': 'Basic',
  'ai.tierPlus': 'Plus',
  ...
  'aihm.intro':
    'Türkiye AİHS’e taraftır; bu öncü kararlar iç hukukta dayanak ve atıf değeri taşır. Dönüm noktası kararlarını Türkçe özetledik; özetler kararın kendisinin yerini tutmaz, dayanak gösterirken tam metne bakın.',
  ...
  'admin.aiToday': 'Bugünkü istek',
  'admin.aiTodayHint': '{token} token',
  'admin.aiProfit': 'Bu ay kâr',
  'admin.aiProfitHint': 'satış {satis} ₺ · gider {gider} ₺',
  'admin.aiCredit': 'Yüklü kontör',
  ...
  'mut.title': 'Derin Araştırma',
  'mut.short': 'Derin Araştırma',
  ...
  'dlk.lead': 'Türü seçin, olayı anlatın; uygulama mevzuat ve içtihattan yararlanarak bir dilekçe TASLAĞI yazar. Hazır şablon değil, olayınıza göre yazılmış bir ilk metindir — mahkemeye sunmadan önce baştan sona sizin denetlemeniz gerekir.',
  ...
  'docrev.lead': 'PDF, UYAP UDF veya Word dosyanızı yükleyin (ya da metni yapıştırın); uygulama belgede geçen süreleri, eksik görünen noktaları ve dikkat edilmesi gereken maddeleri LİSTELER. Hangisinin sizin dosyanızda önemli olduğuna siz karar verirsiniz.',
  ...
  'ictihat.hintSmart': 'Akıllı: önce kelimelerin yan yana geçtiği kararlar, sonra ayrı ayrı geçenler. Çoğu arama için en iyisi.',
  'ictihat.hintExact': 'Tam ifade: yalnız kelimelerin birebir yan yana ve aynı sırada geçtiği kararlar. Az ama isabetli sonuç.',
  'ictihat.hintExactSingle': 'Tam ifade yalnız birden fazla kelime yazınca işe yarar. Tek kelimede Akıllı ile aynı sonucu verir.',
  'ictihat.hintRecent': 'En yeni: alakaya değil, karar tarihine göre sıralar. En son verilen kararlar başa gelir.',
