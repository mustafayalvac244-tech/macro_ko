...
|---|---|---|
| `once-dusun` | Canlıyı değiştiren HER işten önce: bir ayar sayısını büyütürken (işçi, eşzamanlılık, sıklık, limit), cron kurarken, uç dağıtırken, göç uygularken, dış servise yazarken, teşhis söylerken, koruma testi yazarken | 18/19.09.2026: vektörleme işçisi 64'e çıkarıldı, veritabanı 7,5 saat bağlantı kabul etmedi. Sebep işçi sayısı değil, her çağrıda koşan 70 bin satırlık bir sayımın 64 ile çarpılmasıydı — ve uyarı (`"remaining":null`) ekrandaydı, üstünden geçildi. |
