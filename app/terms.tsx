...
const sectionsTr = (): Section[] => [
  ...
  {
    icon: 'lock-closed-outline',
    title: '18. Müvekkil Verileri Bakımından Veri İşleyen Taahhütlerimiz',
    body: 'Dava ve müvekkil kayıtlarınızdaki üçüncü kişi verileri bakımından VERİ SORUMLUSU sizsiniz; Vekil Pro bu verileri sizin adınıza işleyen VERİ İŞLEYENDİR. 6698 sayılı Kanun’un 12/2. maddesi uyarınca güvenlik tedbirlerinden sizinle birlikte sorumlu olduğumuz için şu taahhütleri veririz:\n\n(a) TALİMATLA SINIRLI İŞLEME. Bu verileri yalnızca hizmeti sunmak için ve uygulama üzerinden verdiğiniz talimatlarla işleriz. Kendi amaçlarımız için kullanmayız, satmayız, reklam için kullanmayız ve kendi yapay zekâ modelimizi eğitmek için kullanmayız.\n\n(b) ERİŞİM. Kayıtlarınız veritabanında satır düzeyinde yalnızca sizin hesabınıza kilitlidir. İçeriğine; arıza giderimi, güvenlik incelemesi veya yasal zorunluluk dışında erişilmez, erişildiğinde gerekli olduğu kadar ve gizlilik içinde erişilir.\n\n(c) ALT İŞLEYENLER. Verilerin aktarıldığı hizmet sağlayıcıların tam listesi Gizlilik ve KVKK metninin 6. başlığındadır. Bu listeye yeni bir sağlayıcı eklenirse metin güncellenir ve size bildirilir.\n\n(ç) İHLAL BİLDİRİMİ. Kayıtlarınızı etkileyen bir veri ihlalini öğrendiğimizde size GECİKMEKSİZİN bildiririz; böylece Kanun’un 12/5. maddesi ve Kurul’un 72 saatlik bildirim süresi bakımından kendi yükümlülüğünüzü yerine getirebilirsiniz. Bildirimde neyin, ne zaman ve nasıl etkilendiğini o an bildiğimiz kadarıyla yazarız.\n\n(d) SİLME VE İADE. Hesabınızı sildiğinizde kayıtlarınız silinir (yedeklerin süresi 13. maddededir). Silmeden önce kayıtlarınızı dışa aktarabilirsiniz.\n\n(e) BİLGİ VERME. Talebiniz üzerine bu taahhütlerin nasıl yerine getirildiğine ilişkin yazılı bilgi veririz.\n\nBu madde, Kanun’dan doğan emredici yükümlülüklerimizi daraltmaz; 14. maddedeki sorumluluk sınırı, kanunen sınırlanamayan sorumluluklara uygulanmaz.',
  },
];
...
const sectionsEn = (): Section[] => [
  ...
  {
    icon: 'lock-closed-outline',
    title: '18. Our Commitments as Data Processor for Client Data',
    body: 'For third-party personal data in your case and client records, YOU are the DATA CONTROLLER and Vekil Pro is the DATA PROCESSOR acting on your behalf. Because Article 12(2) of Law No. 6698 makes us jointly responsible with you for security measures, we commit to the following:\n\n(a) PROCESSING ON INSTRUCTION ONLY. We process this data solely to provide the service and on the instructions you give through the app. We do not use it for our own purposes, sell it, use it for advertising, or use it to train our own AI models.\n\n(b) ACCESS. Your records are locked to your account at row level in the database. Their contents are not accessed except for fault resolution, security investigation or legal obligation, and then only to the extent necessary and in confidence.\n\n(c) SUB-PROCESSORS. The full list of providers to which data is transferred is in section 6 of the Privacy and KVKK notice. If a provider is added, the notice is updated and you are informed.\n\n(d) BREACH NOTIFICATION. When we learn of a data breach affecting your records, we notify you WITHOUT UNDUE DELAY so that you can meet your own obligation under Article 12(5) and the Board\u2019s 72-hour notification period. The notice states what was affected, when and how, as far as we know at that time.\n\n(e) DELETION AND RETURN. When you delete your account your records are deleted (backup retention is set out in section 13). You can export your records before deleting.\n\n(f) INFORMATION. On request we provide written information on how these commitments are met.\n\nThis section does not narrow any mandatory obligation we have under the Law; the limitation in section 14 does not apply to liability that cannot be limited by law.',
  },
];
