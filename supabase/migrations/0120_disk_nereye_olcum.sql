-- DİSK NEREYE GİDİYOR? — ictihat_kararlar'ı sütun sütun tartar. SALT OKUR.
--
-- NEDEN MIGRATION OLDU. Bu sorgu 11.09'da scripts/ altına yazıldı ama HİÇ
-- KOŞULMADI; başlığındaki "ölçmedim" notu bugüne kadar öyle durdu. Canlıda
-- çalıştırmanın tek yolu migration-uygula iş akışı, o da yalnız
-- supabase/migrations/ altını koşturuyor.
--
-- ACELESİ VAR — 12.09.2026 ölçümü:
